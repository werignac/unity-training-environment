...
namespace werignac.CartPole3D
{
    public class CartPole3DGoalGenerator : MonoBehaviour
    {
		...
		[Header("Debug")]
		[SerializeField, Min(0)]
		private float visualVelocityFactor = 1.0f;
		...
		private void Update()
		{
			Debug.DrawLine(cartPole.CartRigidbody.position, cartPole.CartRigidbody.position + new Vector3(Goal.CartVelocityX, 0, Goal.CartVelocityZ) * visualVelocityFactor);
		}
#endif
	}
}
